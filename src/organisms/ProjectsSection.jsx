  ...
  const projects = [
    {
      ...
      codeUrl: 'https://github.com/usuario/crm-web'
    },
    {
      title: 'API RESTful Python',
      desc: 'Servicio backend escalable con autenticación JWT y microservicios',
      technologies: ['Python', 'FastAPI', 'PostgreSQL', 'Docker'],
      demoUrl: 'https://api-demo.example.com',
      codeUrl: 'https://github.com/usuario/api-python'
    },
    {
      title: 'E-commerce React',
      desc: 'Tienda online con carrito, pagos y administrador de inventario',
      technologies: ['React', 'Node.js', 'MongoDB', 'Stripe'],
      demoUrl: 'https://shop-demo.example.com',
      codeUrl: 'https://github.com/usuario/ecommerce-react'
    }
  ];
