...
const translations = {
  es: {
    ...
    skills: 'Habilidades',
    skillsSubtitle: 'Tecnologías con las que 构建o soluciones digitales modernas y escalables',
    projects: 'Proyectos',
  ...
  en: {
    ...
    tech: ['React', 'TypeScript', 'Node.js'],
    skills: 'Skills',
    skillsSubtitle: 'Technologies I use to build modern and scalable digital solutions',
    projects: 'Projects',
